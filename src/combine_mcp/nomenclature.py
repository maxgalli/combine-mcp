...
- ``combine-paper``, ``combine-code``, ``combine-forum``,
  ``combine-hypernews``: local corpora. 24-hour TTL plus a file/dir
  mtime check, so updated corpus files are picked up automatically.
"""
